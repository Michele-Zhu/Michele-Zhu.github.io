...
const languages_frameworks = [{ icon: 'python', isClickable: false }];

const container_f = document.getElementById('languages_frameworks');

languages_frameworks.forEach((tool) => {
  ...
  container_f.appendChild(anchor);
});
